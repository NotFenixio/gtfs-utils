...
const debug = createDebug('gtfs-utils:read-pathways')
const debugNodes = createDebug('gtfs-utils:read-pathways:nodes')
import inMemoryStore from './lib/in-memory-store.ts'
import readStopStations from './lib/read-stop-stations.ts'
