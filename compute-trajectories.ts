...
const debug = createDebug('gtfs-utils:compute-trajectories')
...
import {STOP, STATION} from './lib/location-types.ts'
import readShapes from './read-shapes.ts'
...
export default computeTrajectories
